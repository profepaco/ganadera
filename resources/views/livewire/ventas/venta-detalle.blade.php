<div class="p-2 mt-4 md:flex md:justify-betweend border-2 border-gray-300 hover:border-indigo-500 hover:ring-indigo-500 rounded-md shadow-sm">
    ...
    <div class="md:w-1/4 flex px-3 text-end gap-4">
        <p class="w-full font-semibold text-lg">{{number_format($importe,2)}}</p>
        <button type="button" wire:click="eliminarCampo({{$producto_id}})"><svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 text-red-500 hover:text-red-800"
