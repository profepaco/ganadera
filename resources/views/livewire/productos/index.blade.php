<div>
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mt-4">
        <div class="p-6 text-gray-900">
            <h2 class="text-2xl font-semibold md:flex md:justify-center">Productos registrados</h2>
                            ...
                            <tr>
                                ...
                                <x-table-td>
                                    <div class="flex flex-col md:flex-row justify-center">
                                        <a href="{{route('productos.show',['producto'=>$producto])}}" class="text-gray-500 hover:text-gray-700 mx-2">
                                        ...
                                        <a href="{{route('productos.edit',['producto'=>$producto])}}" class="text-indigo-500 hover:text-indigo-700 mx-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24"
                                                stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        ...
                                        <button wire:click="$emit('mostrarAlerta','{{$producto->id}}')">
            ...
            @else
                <p class="my-3 md:flex md:justify-center gap-1">Todavía no tienes<span class="font-semibold"> productos </span>registrados</p>
            @endif
        </div>
    </div>
